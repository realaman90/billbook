...
export default function InvoiceContactDetails() {
  ...
  const handleInputChange = (value) => {
    if (typeof value === 'object' && value != null) {
      const { name, address, email, businessNumber, phone, pinCode, vat } =
        value;
      client = {
        name,
        address,
          ...
          >
            ...
            <Autocomplete
              ...
              onInputChange={(event, value, reason) =>
                handleClientNameChange(event, value)
              }
            />
            <Input
              input={{
              ...
              helperText={
                emailErrorVal.length > 1 ? 'Please enter a valid Email' : ''
              }
              onChange={(e) => {
